...
use asn1_der::{Asn1DerError, FromDerObject, IntoDerObject};
...
fn test_ok() {
    ...
    [
        ...
        (
            b"\x02\x08\x7f\xf7\xd3\x17\xce\xf1\xa7\x26".as_ref(),
            9221070861274031910,
        ),
        (
            b"\x02\x09\x00\x80\xa5\x4c\x7f\xe5\x0d\x84\xa0".as_ref(),
            9269899520199460000,
        ),
        (
            b"\x02\x09\x00\xff\xff\xff\xff\xff\xff\xff\xff".as_ref(),
            18446744073709551615,
        ),
        (
            b"\x02\x10\x7f\xc8\xa3\xa5\x32\x49\xcc\xf2\x73\xb3\xe9\x4d\xe1\xb6\x33\x61".as_ref(),
            169853733957366961371495358725388383073,
        ),
        (
            b"\x02\x11\x00\x80\xc8\xa3\xa5\x32\x49\xcc\xf2\x73\xb3\xe9\x4d\xe1\xb6\x33\x61"
                .as_ref(),
            171182961953151877244399165785668727649,
        ),
        (
            b"\x02\x11\x00\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff\xff"
                .as_ref(),
...
fn test_err() {
    ...
    [
        ...
        // Number is too large
        (
            b"\x02\x11\x01\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00\x00"
                .as_ref(),
            Asn1DerError::Unsupported,
        ),
        // Length mismatch
